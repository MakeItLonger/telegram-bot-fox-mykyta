...
const lastDigest = 'https://t.me/c/1588797053/13';
...
bot.on('message', async (msg) => {
  ...
  //   (/просит/i.test(text) && /молитис/i.test(text)) ||
  //   (/прохан/i.test(text) && /молитис/i.test(text)) ||
  //   (/моліться/i.test(text) || /молітся/i.test(text))
  //   ) {
  //   const randomNumber = getRandomNumber();
  //   bot.sendMessage(chatID, `*${prayerEncouragements[randomNumber]}*`, { parse_mode: 'MarkdownV2' });
